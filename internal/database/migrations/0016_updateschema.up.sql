...
CREATE UNIQUE INDEX IF NOT EXISTS uq_match_team_players_captain
    ...
    BEGIN
        IF NOT EXISTS (
            ...
            WHERE table_name = 'matches'
              AND column_name = 'winner_match_team_id'
        ) THEN
            ALTER TABLE matches
                ADD COLUMN winner_match_team_id UUID REFERENCES match_teams (id);
        END IF;
    END $$;
